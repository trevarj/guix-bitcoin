...
(define-public libsecp256k1
  (package
    ...
    (source (origin
              ...
              (sha256 (base32 "10cvh8jks3rjg6p7y0vm1v4kw9y7vljbfijj0zxwkxzysxx60w0f"))))
    ...
    (package
      ...
      (source (origin
                ...
                (uri (git-reference
                      ...
                      (commit commit)))
                (file-name (git-file-name name version))
                (sha256 (base32 "13lgc8ag170nnlqvdk211bmra44grp71030v4axwglxn8cc3lrmq"))))
  ...
  (package
    ...
    (source (origin
              ...
              (uri (git-reference
                    ...
                    (commit (string-append "v" version))))
              (file-name (git-file-name name version))
              (sha256 (base32 "1yp0xaizfh6j94k9ld9zhz8qxzdf2bb33hc2czhgxf32df9qha7x"))))
    (build-system gnu-build-system)
    (native-inputs (list autoconf automake libtool))
